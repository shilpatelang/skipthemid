...
const DISHES = [
  ...
  {
  name: "Kokoda",
  description: "Fiji's answer to ceviche, and the quiet centerpiece of every lovo feast and Sunday lunch in the islands. Fresh reef fish (usually walu or mahi-mahi) is cut into cubes and 'cooked' purely by the acid of fresh lime and lemon juice, then drowned in thick, hand-squeezed coconut cream and tossed with finely diced tomato, onion, chili, and spring onion. The result is impossibly silky, bright, and cooling, the coconut rounding off the citrus bite into something almost custard-like. Unlike Latin American ceviche, kokoda leans entirely on coconut rather than oil or corn, a reflection of an island larder where the coconut palm is called 'the tree of life' and turns up in nearly every dish. It is served chilled in a halved coconut shell or a tall glass, eaten with a spoon, and is the kind of food Fijians make the moment a fishing boat comes in. Outside the South Pacific it's almost unheard of, lost in the shadow of better-marketed ceviches.",
  origin: "Suva, Fiji",
  cuisine: "Fijian",
  category: "Seafood",
  latitude: -18.1416,
  longitude: 178.4419,
  imageUrl: "/dishimage/kokoda.jpg",
  imageCredit: "",
  },
  {
  name: "Rēwena Parāoa",
  description: "A living thread back to pre-colonial Aotearoa: a naturally leavened Māori potato sourdough whose starter, the 'bug,' is kept alive and passed down through generations of a whānau (family), sometimes for decades. The starter is built from boiled potato, flour, and sugar left to ferment and capture wild yeasts, then folded into a dough that bakes into a dense, faintly sweet, tangy loaf with a tight golden crumb. It emerged after Europeans introduced both the potato and wheat, and Māori bakers ingeniously married the new ingredients to indigenous fermentation know-how, creating a bread found nowhere else on earth. Rēwena is the bread of the marae (meeting grounds) and the hāngī feast, sliced thick and slathered with butter, and a good loaf is a point of deep family pride, the quality judged entirely by the vitality of that inherited bug. Many Māori cooks will tell you a borrowed rēwena starter is one of the most intimate gifts you can give. Outside New Zealand it is virtually unknown.",
  origin: "Rotorua, New Zealand",
  cuisine: "Māori",
  category: "Bread",
  latitude: -38.1368,
  longitude: 176.2497,
  imageUrl: "/dishimage/rewena-paraoa.jpg",
  imageCredit: "",
  },
  {
  name: "Mumu",
  description: "Not a single dish but the great communal feast of the Papua New Guinea Highlands, cooked in an earth oven where fire-heated river stones are layered with food and buried to steam for hours. Whole pig, sweet potato (kaukau), taro, leafy aibika greens, and banana are wrapped in banana leaves and packed over the glowing stones, the pit sealed with more leaves and earth so the trapped steam slow-cooks everything into smoky tenderness. A mumu is never an everyday meal, it is the engine of Highland social life, prepared for bride-price ceremonies, compensation payments, reconciliations, and the famous sing-sing gatherings where clans display their finery. The pig is the highest currency of status and obligation, and the killing and sharing of it through a mumu cements alliances and settles debts. Whole villages contribute food and labour, and the unearthing of the pit, steam billowing into the cool mountain air, is the climax of the celebration. Despite Papua New Guinea's staggering cultural diversity (over 800 languages), the mumu is a near-universal thread, yet almost completely unknown beyond Melanesia.",
  origin: "Mount Hagen, Papua New Guinea",
  cuisine: "Papua New Guinean (Highlands)",
  category: "Earth Oven Feast",
  latitude: -5.8576,
  longitude: 144.2300,
  imageUrl: "/dishimage/mumu.jpg",
  imageCredit: "",
  },
  {
  name: "Nkwobi",
  description: "The undisputed king of the Igbo bukateria and palm-wine bar, a fiery, gelatinous delicacy of cow foot slow-simmered until the cartilage turns silky and trembling, then bathed in a thick, ochre sauce built on a base of ground ehu (calabash nutmeg) seeds and akanwu (edible potash) that emulsifies palm oil into a glossy, almost creamy dressing. It's finished with fiery ground chili, sliced onions, the bitter-fragrant utazi leaf, and sometimes a scatter of ground crayfish, then served still warm in a carved wooden mortar (okwa) with a chilled bottle of stout or palm wine alongside. Nkwobi is unapologetically a 'sitting' food, the kind of dish that anchors an entire evening of conversation in southeastern Nigeria, eaten slowly with the fingers as the gelatin coats your lips. The potash is the secret, lending both the unmistakable slippery texture and a faint mineral tang that no Western braise can replicate. To most Nigerians it's a beloved staple of Igbo hospitality, yet outside West African enclaves it's barely known.",
  origin: "Enugu, Nigeria",
  cuisine: "Nigerian (Igbo)",
  category: "Appetizer",
  latitude: 6.4584,
  longitude: 7.5464,
  imageUrl: "/dishimage/nkwobi.jpg",
  imageCredit: "",
  },
  {
  name: "Mursik",
  description: "A fermented milk so culturally loaded that Olympic gold medalists are welcomed home with a gourd of it. Among the Kalenjin people of Kenya's Rift Valley, the runners who have dominated world distance running for half a century, mursik is fresh cow or goat milk fermented for days inside a sotet, a specially carved gourd whose interior has been scrubbed and lined with charcoal embers from the senetwet tree (African olive). That charcoal lining is everything: it sterilizes the gourd, imparts a distinctive smoky-ashen flavour and a faint grey tint, and acts as a natural preservative that let pastoralist herders store milk for weeks without refrigeration. The result is thick, tangy, almost yoghurt-like, with a campfire edge unlike any dairy in the world. Mursik is poured at weddings, naming ceremonies, and homecomings, and ceremonially smeared on the foreheads of returning champions. It's daily sustenance and sacred symbol in one, yet beyond the highlands of western Kenya almost no one has tasted it.",
  origin: "Eldoret, Kenya",
  cuisine: "Kalenjin",
  category: "Fermented Drink",
  latitude: 0.5143,
  longitude: 35.2698,
  imageUrl: "/dishimage/mursik.jpg",
  imageCredit: "",
  },
  {
  name: "Tuo Zaafi",
  description: "The soul-staple of northern Ghana, known affectionately as TZ, a smooth, stretchy mound of cooked maize and millet dough whose name comes from the Hausa 'tuwon zaafi,' meaning 'hot food.' The dough is cooked and beaten with a portion of fermented batter that gives it a faint sourness and the signature soft, almost elastic texture, then served in a wet ball you pinch off and dip. What makes TZ unmistakably northern is its partner: ayoyo soup, a slippery, mucilaginous green broth made from jute leaves, often alongside a dark, earthy bito (dawadawa / fermented locust bean) soup that lends a pungent, miso-like depth. Unlike the rice and plantain of southern Ghana, TZ belongs to the savanna, the daily bread of the Dagomba, Gonja, and Mossi communities around Tamale, eaten with the right hand from a shared bowl. It's filling, cheap, and deeply regional, a dish that signals home for northerners and bafflement for southern Ghanaians who grew up on banku and fufu instead.",
  origin: "Tamale, Ghana",
  cuisine: "Northern Ghanaian (Dagomba)",
  category: "Staple",
  latitude: 9.4008,
  longitude: -0.8393,
  imageUrl: "/dishimage/tuo-zaafi.jpg",
  imageCredit: "",
  },
  {
  name: "Doubles",
  description: "Trinidad's national breakfast and the undefeated champion of its street-corner food culture, born from the island's Indian indentured-labour heritage and perfected into something wholly Trinidadian. Two soft, turmeric-yellow flatbreads called bara (the 'double' of the name) cradle a scoop of curried channa, chickpeas stewed soft in cumin, garlic, and a warming masala, then dressed to order with a dizzying array of condiments: fiery scotch-bonnet pepper sauce, sweet-sour tamarind chutney, cooling cucumber, mango kuchela, and shado beni (culantro) chutney. The vendor's rapid-fire question, 'slight, medium, or plenty pepper?', is a rite of passage. Doubles are eaten standing up, the whole soft, saucy parcel folded into wax paper and devoured in a few messy bites before the bara dissolves. At well under a US dollar they're the great equalizer, eaten by bankers and laborers alike from dawn carts across Port of Spain, yet astonishingly rare outside Trinidad and its diaspora pockets.",
  origin: "Port of Spain, Trinidad and Tobago",
  cuisine: "Trinidadian (Indo-Caribbean)",
  category: "Street Food",
  latitude: 10.6549,
  longitude: -61.5019,
  imageUrl: "/dishimage/doubles.jpg",
  imageCredit: "",
  },
  {
  name: "Mannish Water",
  description: "A Jamaican goat-offal soup with a fearsome reputation as a virility tonic, traditionally served to the groom on his wedding night and ladled out at the rowdiest stage of any rural celebration. Everything from the goat is used, the head, tripe, feet, and other offal, simmered for hours with green bananas, yam, cho-cho (chayote), spinners (hand-rolled flour dumplings), scotch-bonnet pepper, thyme, and a generous splash of white rum stirred in at the end. The long, bony cook yields a deeply gelatinous, peppery broth that's considered restorative and aphrodisiac in equal measure. Mannish water is a fixture of the Jamaican 'curry goat' cook-out, where the prized cuts go to the curry and the rest, nothing wasted, becomes the soup. The name itself winks at its supposed power to 'make a man.' It's celebration food and folk medicine in one pot, ubiquitous in rural Jamaica yet largely a mystery to visitors who never leave the resort buffet.",
  origin: "Kingston, Jamaica",
  cuisine: "Jamaican",
  category: "Soup",
  latitude: 17.9714,
  longitude: -76.7920,
  imageUrl: "/dishimage/mannish-water.jpg",
  imageCredit: "",
  },
  {
  name: "Kak'ik",
  description: "A turkey soup of the Q'eqchi' Maya of Guatemala's misty Verapaz highlands, so ancient and culturally vital that the Guatemalan government declared it part of the nation's intangible cultural heritage. The name fuses the Q'eqchi' words for 'red' (kaq) and 'chili' (ik), and the broth earns it: a clear, blazing-red consommé built from native chiles (cobanero, guaque, and chile zambo) toasted and ground with tomato, tomatillo, achiote, and a backbone of indigenous aromatics, mint, cilantro, and the anise-like samat herb. A whole native turkey (chompipe) is simmered in it until the meat falls from the bone, and the soup is served with tamalitos blancos (small plain corn tamales) and white rice. Kak'ik is feast food, prepared for weddings, funerals, and Maya ceremonial occasions, often cooked outdoors in vast clay pots over wood fire. Its lineage reaches back to pre-Columbian turkey-and-chili stews, making it one of the oldest continuously prepared dishes in the Americas, yet it remains almost entirely unknown beyond the Verapaces.",
  origin: "Cobán, Guatemala",
  cuisine: "Mayan (Q'eqchi')",
  category: "Soup",
  latitude: 15.4711,
  longitude: -90.3711,
  imageUrl: "/dishimage/kak-ik.jpg",
  imageCredit: "",
  },
  {
  name: "Chairo",
  description: "A fortifying Andean soup from the high Bolivian altiplano around La Paz, built on the single ingredient that defines the region's genius for survival at 4,000 metres: chuño, potatoes freeze-dried by an ancient Aymara technique of leaving them out on the frigid plateau to freeze at night and be trampled and sun-dried by day, drawing out the moisture until they become black, rock-hard nuggets that keep for years. Rehydrated, the chuño lends chairo its unmistakable earthy, smoky, almost mineral depth. The soup simmers chuño and fresh potato together with lamb and beef, dried corn (mote), wheat berries, peas, fava beans, and a sofrito of onion, garlic, and yellow ají, into a thick, sustaining one-pot meal made for the thin cold air. Chairo is everyday Aymara comfort food and a fixture of La Paz markets and family Sundays, a dish that tastes of the altiplano itself. The chuño at its heart is a 2,000-year-old food technology that fed the Inca empire, yet remains baffling and unknown to most of the outside world.",
  origin: "La Paz, Bolivia",
  cuisine: "Bolivian (Aymara)",
  category: "Soup",
  latitude: -16.5000,
  longitude: -68.1500,
  imageUrl: "/dishimage/chairo.jpg",
  imageCredit: "",
  }
];
...
const TAXONOMY: Record<string, DishTaxonomy> = {
  ...
  "Kokoda": { continent: "oceania", country: "fiji", course: "appetizer", dietType: "non-vegetarian" },
  "Rēwena Parāoa": { continent: "oceania", country: "new-zealand", course: "side", dietType: "vegan" },
  "Mumu": { continent: "oceania", country: "papua-new-guinea", region: "highlands", course: "main", dietType: "non-vegetarian" },
  "Nkwobi": { continent: "africa", country: "nigeria", course: "appetizer", dietType: "non-vegetarian" },
  "Mursik": { continent: "africa", country: "kenya", region: "rift-valley", course: "snack", dietType: "vegetarian" },
  "Tuo Zaafi": { continent: "africa", country: "ghana", region: "northern", course: "main", dietType: "vegetarian" },
  "Doubles": { continent: "north-america", country: "trinidad-and-tobago", course: "street-food", dietType: "vegan" },
  "Mannish Water": { continent: "north-america", country: "jamaica", course: "appetizer", dietType: "non-vegetarian" },
  "Kak'ik": { continent: "north-america", country: "guatemala", region: "alta-verapaz", course: "main", dietType: "non-vegetarian" },
  "Chairo": { continent: "south-america", country: "bolivia", region: "la-paz", course: "main", dietType: "non-vegetarian" },
};
